...
do
    ...
    export CFLAGS="-O3 -I$APP_ROOT/include/python2.7 -I$APP_ROOT/include/"
    ...
    cp -RL build/lib.android-$ARCH-2.7/bson $PREFIX/android/$ARCH/python/site-packages/
    cp -RL build/lib.android-$ARCH-2.7/gridfs $PREFIX/android/$ARCH/python/site-packages/
    cp -RL build/lib.android-$ARCH-2.7/pymongo $PREFIX/android/$ARCH/python/site-packages/
