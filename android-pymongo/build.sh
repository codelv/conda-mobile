...
do
    ...
    cp -RL build/lib.android-$ARCH-$PY_VER/bson $PREFIX/android/$ARCH/python/site-packages/
    cp -RL build/lib.android-$ARCH-$PY_VER/gridfs $PREFIX/android/$ARCH/python/site-packages/
    cp -RL build/lib.android-$ARCH-$PY_VER/pymongo $PREFIX/android/$ARCH/python/site-packages/
