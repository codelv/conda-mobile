...
# Copy to output
cp -RL build/lib.darwin-arm-2.7/atom $PREFIX/iphoneos/python/site-packages/
cp -RL build/lib.darwin-x86_64-2.7/atom $PREFIX/iphonesimulator/python/site-packages/
